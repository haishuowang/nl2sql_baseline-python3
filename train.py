...
if __name__ == '__main__':
    ...
    root_path = os.getcwd()
    word_emb = load_word_emb(f'{root_path}/data/char_embedding.json')
    ...
    for i in range(args.epoch):
        ...
        print('Sel-Num: %.3f, Sel-Col: %.3f, Sel-Agg: %.3f, W-Num: %.3f, W-Col: %.3f, '
              'W-Op: %.3f, W-Val: %.3f, W-Rel: %.3f' % (dev_acc[0][0], dev_acc[0][1], dev_acc[0][2],
                                                        dev_acc[0][3], dev_acc[0][4], dev_acc[0][5],
